...
-- desde `group_members`.
--
-- Se aplica con el rol DUEÑO (`supabase_admin`), como las demás.
-- ============================================
...
-- La 0043 se puede repetir sin daño: borra la política antes de crearla y la función se reemplaza.
